...
function loadScene(){
    ...
    var geometriaTexto = new THREE.TextGeometry('Three.js',
    {
        size:1,
        height: 0.1,
        curveSegments: 3, //Mas alto mas definido
        font: 'droid serif',
        weight : 'bold',
        style: 'normal',
        bevelThickness: 0.05,
    ...
    var texto = new THREE.Mesh(geometriaTexto, wallsMaterial);

    texto.posicion.set(-3,0,2);
    ...
    */
    ...
    var movieGeometry = new THREE.PlaneGeometry(600,300,10,10);

    var movieScreen = new THREE.Mesh( movieGeometry, movieMaterial);

    movieScreen.position.set(0, 150, -250);
...
function setupGui(){
    ...
    h.add(effectController, "mensaje").name("Aplicación");//Objeto con controles
    //Slider => Limite inf, sup, incremento
    h.add(effectController, "giroY", -180.0, 180.0, 0.025).name("Giro en Base");//Objeto con controles
    ...
    h.add(effectController, "giroBaseZ", -180.0, 180.0, 0.025).name("Giro de Hombro Z");//Objeto con controles

    h.add(effectController, "giroRotulaX", -180.0, 180.0, 0.025).name("Giro de Codo X");//Objeto con controles
    h.add(effectController, "giroRotulaY", -180.0, 180.0, 0.025).name("Giro de Codo Y");//Objeto con controles
    h.add(effectController, "giroRotulaZ", -180.0, 180.0, 0.025).name("Giro de Codo Z");//Objeto con controles

    h.add(effectController, "cerrarPinzas", 9, 25, 0.025).name("Pinzas");//Objeto con controles
    //Combo box
...
function update() {
    ...
    pinzaIz.position.set(0,0, -effectController.cerrarPinzas/2);
    pinzaDe.position.set(0,0, +effectController.cerrarPinzas/2);
